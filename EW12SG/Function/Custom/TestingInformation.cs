...
namespace EW12SG.Function.Custom {
    ...
    public class TestingInformation : INotifyPropertyChanged {
        ...
        string _check_lan;
        public string checkLanPort {
            get { return _check_lan; }
            set { _check_lan = value; OnPropertyChanged(nameof(checkLanPort)); }
        }
        string _check_wan;
        ...
        public bool isCheckLan {
            ...
            set { _is_check_lan = value; OnPropertyChanged(nameof(isCheckLan)); }
        }
