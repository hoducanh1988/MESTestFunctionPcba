...
namespace EW12S.Function.IO {
    public class LogDetailFile {
        ...
        public void createLog() {
            ...
            //create log uart
            string file_log_uart = string.Format("EW12S_{0}_{1}_{2}_uart.txt", mac, DateTime.Now.ToString("HHmmss"), myGlobal.myTesting.totalResult);
            File.WriteAllText(System.IO.Path.Combine(logdir, file_log_uart), "Product: EW12S\r\n" + myGlobal.myTesting.logUart, Encoding.Unicode);
        }
